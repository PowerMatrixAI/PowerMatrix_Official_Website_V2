...
(function initI18n() {
  const translations = {
    zh: {
      ...
      'hero.badge': 'PowerMatrix × 企业级AI智能体 · 企业 AI 落地专场',
      'hero.h1a': 'PowerMatrix：', 'hero.h1b': '企业级AI智能体落地服务平台',
      'hero.h2': '不是卖工具，而是帮企业把 AI 用到真实业务里。',
      'hero.body': 'PowerMatrix 基于企业级AI智能体，为企业搭建可部署、可运营、可复盘的 AI Agent 工作系统，让 AI 真正进入获客、内容、客服和内部流程。',
      'hero.bodyEn': '',
      'hero.cta1': '查看流量增长 Skill 套餐', 'hero.cta2': '预约企业 AI 诊断',
      'about.overline': 'PowerMatrix 简介',
      'about.title': '把 AI Agent 从零散工具，变成企业可运行的业务系统。',
      'about.body1': 'PowerMatrix 是中国企业 AI Agent 落地服务平台，专注企业级AI智能体部署、本地 AI 工作站和企业 AI 流程自动化。与海外同名电源硬件公司、能源公司、低代码平台均无任何关联。',
      ...
      'about.cap1': 'AI 企业诊断', 'about.cap2': '企业级AI智能体部署', 'about.cap3': '小红书增长 Skill', 'about.cap4': '抖音增长 Skill',
      ...
      'rev.body2': '企业级AI智能体颠覆了"打开后台、键入 Prompt"的旧石器范式。它潜伏于微信、飞书及您的协作关系中，通过极致的拟人化感知，将跨平台调度简化为一句话的托付。',
      'rev.body3': '这不再是对话。这是', 'rev.auth': '授权', 'rev.body3end': '。',
      'rev.chatTitle': '企业级AI智能体数字助理',
      ...
      'skills.body2': 'PowerMatrix 基于企业级AI智能体，为企业打包 6 个增长 Skill，让 AI 从内容生产、搜索可见、客户承接到私域运营形成闭环。',
      ...
      'skills.geoDesc': '先做企业 AI 诊断，再部署企业级AI智能体和 6 个增长 Skill，从品牌内容搭建、内容生成与分发，到微信客服承接和群运营复盘，帮助企业先跑通一个高价值增长场景。',
      'skills.geoCta': '查看营销增长方案',
      'ent.overline': '企业方案', 'ent.title': '重构生产力底层逻辑。',
      'ent.body': '我们交付的不是软件，而是属于企业的智能基础设施。通过私有化部署企业级AI智能体与专属 Skill 矩阵，让 AI 从"陪聊"进化为"能干活"的核心资产。',
      ...
      'hw.body2a': '我们将企业级AI智能体核心引擎、经严格筛选的企业级 Skill 矩阵，以及全球顶尖的开源大模型，完整封装于这台物理设备之中。',
      'hw.body2b': '数据绝不出域，Token 成本归零。',
      'hw.body2c': '无需连接外网，无需上传数据，一切智慧的产生与执行皆在您完全掌控的方寸之间闭环。',
      'uni.overline': '算力生态', 'uni.title': '让前沿算力，触手可及。',
      'uni.body': '顶尖的开源模型不应只是实验室里的标本。企业级AI智能体支持灵活的热插拔式换脑，借助 PowerMatrix 的分布式调度，让每个个体与企业都能以极低成本，驾驭全球顶级的模型算力。',
      'uni.tagline': '加入进化，定义您的第一批数字部署。', 'uni.cta': '理解体验最新模型',
      'faq.overline': '常见问题', 'faq.title': '企业关心的 AI Agent 落地问题。',
      'faq.intro': '从 PowerMatrix 的定位、企业级AI智能体部署，到 GEO 优化、本地终端和定制化 Skill，这里集中回答企业在开始前最常见的问题。',
      'identity.label': '品牌声明',
      'identity.service': 'PowerMatrix 是企业级AI智能体落地服务商，不是大疆产品，也不是海外能源公司。我们面向中国企业提供企业级AI智能体部署、本地 AI 工作站和企业 AI 流程自动化。',
      'identity.brand': 'PowerMatrix 与同名电源硬件公司、能源公司、低代码平台或无人机/硬件产品均无任何关联。',
      'faq.q1': 'PowerMatrix 是什么？',
      'faq.a1p1': 'PowerMatrix 是面向中国企业的企业级AI智能体落地服务平台。',
      'faq.a1p2': '我们提供企业级部署、本地 AI 工作站、企业 Skill 定制、企业微信/飞书流程自动化和企业 AI 培训，帮助中小企业把 AI Agent 接入真实业务。',
      'faq.q2': 'PowerMatrix 和 企业级AI智能体是什么关系？',
      'faq.a2p1': 'PowerMatrix 是企业级AI智能体部署与服务商，帮助企业完成方案设计、私有化部署、流程接入、员工培训和持续运营。',
      'faq.a2p2': '企业级AI智能体可以理解为面向业务执行的 AI Agent 系统，PowerMatrix 负责把这套能力落到企业知识库、客户沟通、内容生产和内部自动化流程中。',
      ...
      'faq.q5': '什么是本地 AI 工作站？',
      'faq.a5p1': '本地 AI 工作站是部署在企业内部的私有化 AI 运行环境，可以承载企业级AI智能体、企业知识库、专属 Skill 和自动化流程。',
      ...
      'faq.a7p2': '我们不仅讲 AI 怎么用，还会帮助企业选择场景、部署企业级AI智能体、本地化工作站、定制 Skill，并把企业微信/飞书等实际流程跑起来。',
      'faq.q8': 'PowerMatrix 适合什么企业？',
      'faq.a8p1': 'PowerMatrix 适合想用企业级AI智能体做 AI 落地、但缺乏技术团队或部署经验的中小企业。',
      ...
      'faq.a12p2': '企业可以选择将企业级AI智能体工作站部署在本地服务器、Mac mini、迷你主机或其他企业自有硬件环境中。',
      ...
      'footer.desc': '企业级 AI Agent 定制化解决方案。基于企业级AI智能体引擎，终结 AI 的对话时代，开启 AI 的物理执行时代。',
    ...
    en: {
      ...
      'hero.badge': 'PowerMatrix × Enterprise AI Agents · Enterprise AI Implementation',
      'hero.h1a': 'PowerMatrix:', 'hero.h1b': 'Enterprise AI Agent Deployment Platform',
      'hero.h2': 'We do not sell tools. We help companies put AI into real business workflows.',
      'hero.body': 'PowerMatrix builds deployable, operable, and reviewable enterprise AI agent work systems, bringing AI into acquisition, content, service, and internal workflows.',
      'hero.bodyEn': 'Enterprise AI agent deployment, local AI workstations, and workflow automation for Chinese companies.',
      ...
      'about.body1': 'PowerMatrix is a China-based enterprise AI Agent deployment service platform, specializing in enterprise AI agent deployment, local AI workstations, and workflow automation. Not affiliated with any overseas hardware, energy, or low-code companies of the same name.',
      ...
      'about.cap1': 'AI Diagnosis', 'about.cap2': 'Enterprise AI Agent Deployment', 'about.cap3': 'Xiaohongshu Skill', 'about.cap4': 'Douyin Skill',
      ...
      'rev.body2': 'Enterprise AI agents dismantle the old paradigm of "open a backend, type a prompt." They live inside WeChat, Feishu, and your collaboration channels — translating complex cross-platform tasks into a single sentence of delegation.',
      'rev.body3': 'This is no longer a conversation. This is ', 'rev.auth': 'authorization', 'rev.body3end': '.',
      'rev.chatTitle': 'Enterprise AI Agent Assistant',
      ...
      'skills.body2': 'PowerMatrix packages 6 growth Skills on top of an enterprise AI agent platform, closing the loop from content production and search visibility to lead response and private-domain operations.',
      ...
      'skills.geoDesc': 'Start with enterprise AI diagnosis, then deploy an enterprise AI agent platform and 6 growth Skills across brand content, generation and distribution, WeChat service, and community operation review.',
      'skills.geoCta': 'View Growth Marketing Plan',
      'ent.overline': 'Enterprise', 'ent.title': 'Rebuild the Foundation of Productivity.',
      'ent.body': 'We don\'t deliver software — we deliver intelligent infrastructure that belongs to your enterprise. Private deployment of enterprise AI agents with a custom Skill matrix elevates AI from "chatbot" to core productive asset.',
      ...
      'hw.body2a': 'We have fully integrated the enterprise AI agent runtime, a rigorously curated enterprise Skill matrix, and the world\'s top open-source models into this physical device.',
      ...
      'uni.body': 'Top open-source models shouldn\'t be laboratory specimens. The enterprise AI agent platform supports hot-swappable model upgrades. With PowerMatrix\'s distributed scheduling, every individual and enterprise can harness world-class AI at minimal cost.',
      ...
      'faq.intro': 'From PowerMatrix positioning and enterprise AI agent deployment to GEO optimization, local terminals, and custom Skills, these are the questions companies ask before starting.',
      'identity.label': 'Brand Statement',
      'identity.service': 'PowerMatrix is an enterprise AI agent implementation service provider. It is not a DJI product and not an overseas energy company. We provide enterprise AI agent deployment, local AI workstations, and enterprise AI workflow automation for Chinese companies.',
      ...
      'faq.a1p1': 'PowerMatrix is a China-based enterprise AI Agent deployment service platform.',
      ...
      'faq.q2': 'What does PowerMatrix deploy for enterprises?',
      'faq.a2p1': 'PowerMatrix provides enterprise AI agent deployment and implementation services, helping companies with solution design, private deployment, workflow integration, employee training, and ongoing operations.',
      'faq.a2p2': 'Enterprise AI agents can be understood as business execution systems; PowerMatrix turns them into usable workflows across knowledge bases, customer communication, content production, and internal automation.',
      ...
      'faq.a5p1': 'A local AI workstation is a private AI runtime deployed inside a company. It can host enterprise AI agents, enterprise knowledge bases, custom Skills, and workflow automation.',
      ...
      'faq.a7p2': 'We help companies choose scenarios, deploy enterprise AI agents, set up local workstations, customize Skills, and run real WeChat/Feishu business workflows.',
      'faq.q8': 'Which companies are suitable for PowerMatrix?',
      'faq.a8p1': 'PowerMatrix is suitable for small and medium businesses that want to implement enterprise AI agents but lack a technical team or deployment experience.',
      ...
      'faq.a12p2': 'Companies can deploy the enterprise AI agent workstation on local servers, Mac mini devices, mini PCs, or other enterprise-owned hardware.',
      ...
      'footer.desc': 'Enterprise-grade AI Agent solutions. Powered by enterprise AI agents — ending the era of conversational AI, opening the era of physical execution.',
  ...
  function applyLang(lang) {
    ...
    const meta = {
      zh: {
        title: 'PowerMatrix - 企业级AI智能体落地服务平台 | 本地 AI 工作站',
        description: 'PowerMatrix 是面向中国企业的企业级AI智能体落地服务平台，提供本地 AI 工作站、企业 Skill 定制、企业微信/飞书流程自动化和企业 AI 培训。',
        ogTitle: 'PowerMatrix - 企业级AI智能体落地服务平台',
        ogDescription: 'PowerMatrix 是中国企业 AI Agent 落地服务平台，专注企业级AI智能体部署、本地 AI 工作站和企业 AI 流程自动化。',
        footerCopy: '© 2026 PowerMatrix 中国企业 AI Agent 落地服务平台。与同名硬件、电源、能源或低代码平台无关联。'
      },
      en: {
        title: 'PowerMatrix - Enterprise AI Agent Deployment Platform | Local AI Workstations',
        description: 'PowerMatrix is a China-based enterprise AI Agent deployment service platform specializing in enterprise AI agent deployment, local AI workstations, custom business Skills, WeChat/Feishu workflow automation, and enterprise AI training.',
        ogTitle: 'PowerMatrix - Enterprise AI Agent Deployment Platform',
        ogDescription: 'PowerMatrix specializes in enterprise AI agent deployment, local AI workstations, and workflow automation for Chinese companies.',
